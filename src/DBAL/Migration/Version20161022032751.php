 ...
 */
class Version20161022032751 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE notifications (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', recipient_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', date_sent DATETIME DEFAULT NULL, date_read DATETIME DEFAULT NULL, status VARCHAR(255) NOT NULL, created DATETIME NOT NULL, type VARCHAR(255) NOT NULL, subject_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', INDEX IDX_6000B0D3E92F8F78 (recipient_id), INDEX IDX_6000B0D323EDC87 (subject_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
